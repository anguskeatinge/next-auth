    ...
    try {
      ...
      try {
        ...
        if (adapter) {
          ...
          isSignedInAs = sessionAndUser === null || sessionAndUser === void 0 ? void 0 : (_sessionAndUser$user = sessionAndUser.user) === null || _sessionAndUser$user === void 0 ? void 0 : _sessionAndUser$user.email;
        }
